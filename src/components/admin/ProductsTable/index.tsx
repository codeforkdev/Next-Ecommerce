...
export function ProductsTable<TValue, TData>({
  ...
  return (
    <>
      <section className="flex  gap-2 bg-white mb-2 rounded-lg border ">
          ...
          <div className="flex items-center justify-between border-b p-4">
            ...
            <Button asChild>
              <Link
                ...
                className="flex gap-2 items-center  text-white py-1 px-4 rounded text-sm"
              >
                Add Product
              </Link>
            </Button>
          ...
          <div className="flex p-4 gap-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  className="flex gap-2 py-1 px-5 text-sm"
